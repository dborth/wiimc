...
extern const u8		playbar_close_png[];
extern const u32	playbar_close_png_size;
extern const u8		playbar_slideshow_png[];
extern const u32	playbar_slideshow_png_size;
